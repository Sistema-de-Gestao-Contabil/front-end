...
const createTransactionForm = z.object({
  value: z.string().nonempty("O valor deve ser informado."),
  ...
  //   .default(1),
  status: z
    .number({ required_error: "O status deve ser informado." })
    .default(0),
});
    ...
    <>
      ...
      >
        <form className="flex flex-col w-full p-4 max-w-[600px]">
          <label htmlFor="value" className="text-[#444557]">
            Valor
          </label>
          <input
          ...
          <label htmlFor="description" className="text-[#444557] mt-8">
            Descrição
          </label>
          <input
            className="h-10 w-full pl-3 bg-[#F5F5FE] text-[#444557] rounded-xl border-none"
          ...
          <label htmlFor="category" className="text-[#444557] mt-8">
            Categoria
          </label>
          <div className="w-full z-50">
            <div className="h-10 pl-3 flex items-center bg-[#F5F5FE] text-[#444557] rounded-xl">
              <div
              ...
              <button
                type="button"
                className=" ml-3 bg-blue-600 h-10 flex justify-center items-center text-white w-10 rounded-md"
                onClick={() => {
                  setShowInput(!showInput);
                }}
              >
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="w-[25%] flex gap-3">
                        <button
                          type="button"
                          className="h-10 rounded-md text-white bg-blue-600 p-2 flex items-center hover:bg-blue-700"
                        >
                          Editar
                        </button>
          ...
          {showInput ? (
            <div className=" mt-10 flex-col items-center rounded-xl border-2 border-blue-600 p-5">
              <div className="flex-col">
                <div>
                  <label htmlFor="type" className="text-[#444557]">
                    Nome
                  </label>
                  <input
                    type="text"
                    className="bg-[#F5F5FE] outline-none w-full h-10 mb-3 rounded-xl pl-3 text-[#444557]"
                ...
                <div className="flex-col">
                  <label htmlFor="company" className="text-[#444557]">
                    Empresa
                  </label>
              ...
              <div className="w-full flex justify-end">
                <button
                  ...
                  className="h-10 rounded-md mr-3 justify-center w-[80px] text-white bg-blue-600 p-2 flex items-center hover:bg-blue-700"
                >
                  Salvar
                </button>
          ...
          <label htmlFor="company" className="text-[#444557] mt-8">
            Empresa
          </label>
          ...
          <label htmlFor="type" className="text-[#444557] mt-8">
            Tipo
          </label>
          <Select
          ...
          <label htmlFor="status" className="text-[#444557] mt-8">
            Status
          </label>
          <Select
