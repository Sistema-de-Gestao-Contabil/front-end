...
export default function Despesas() {
    ...
    return (
        <>
            <Heading title="Salários" subtitle="Pagamento de salário dos funcionários" />
            ...
            <div style={{
                ...
                <form className="flex flex-col w-full p-4 max-w-[600px]">
                    ...
                    <Button className="m-auto mt-8 w-[200px]" type="button" onClick={handleSubmit(createTransaction)}>Realizar Pagamento</Button>
                </form>
